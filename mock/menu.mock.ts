      ...
      data: [
        {
          ...
          children: [
            ...
            {
              path: "datasources",
              component: "system/datasources/index",
              name: "Datasources",
              meta: {
                title: "数据源配置",
                icon: "setting",
        ...
        },
        {
          path: "/knowledge",
          component: "Layout",
          redirect: "/knowledge/preparation",
          name: "/knowledge",
          meta: {
            title: "知识管理",
            icon: "system",
          ...
          children: [
            {
              path: "preparation",
              component: "knowledge/preparation/index",
              name: "Preparation",
              meta: {
                title: "知识准备",
                icon: "el-icon-User",
            ...
            {
              path: "extraction",
              component: "knowledge/extraction/index",
              name: "Extraction",
              meta: {
                title: "知识抽取",
                icon: "role",
            ...
            {
              path: "audit",
              component: "knowledge/audit/index",
              name: "Audit",
              meta: {
                title: "知识审核",
                icon: "menu",
            ...
            {
              path: "mapping",
              component: "knowledge/mapping/index",
              name: "Mapping",
              meta: {
                title: "知识映射",
                icon: "tree",
            ...
            {
              path: "fusion",
              component: "knowledge/fusion/index",
              name: "Fusion",
              meta: {
                title: "知识融合",
                icon: "dict",
            ...
            {
              path: "complement",
              component: "knowledge/complement/index",
              name: "Complement",
              meta: {
                title: "自动补充",
                icon: "document",
